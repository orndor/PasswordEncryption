...
namespace PasswordEncryption
{
    public class App
    {
        ...
        public static void MakeAccount(Dictionary<string,string> usernameDict)
        {
            Console.Clear();
            Console.WriteLine("--------------------------------------------------------------------\n");
            ...
            Console.WriteLine($"Password (Hashed): {usernameDict[username]}");
            Console.WriteLine("\n");
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey();
            MainMenu(usernameDict);
        }
        public static void Authenticate(Dictionary<string, string> usernameDict)
        {
            Console.Clear();
            Console.WriteLine("--------------------------------------------------------------------\n");
